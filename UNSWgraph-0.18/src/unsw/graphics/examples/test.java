 ...
 */
public class test extends Application3D implements KeyListener {
    ...
    public void display(GL3 gl) {
    	...
    	Point3D p3 = new Point3D( 0 , 1 , -0.5f );
    	...
    	botttom_left.draw( gl , CoordFrame3D.identity().translate(0, 1, -15) );
//        
